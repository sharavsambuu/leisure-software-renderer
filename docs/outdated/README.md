...
| [sdl3_cutover_runbook.md](sdl3_cutover_runbook.md) | `docs/backlog/` | Executed & verified 2026-09-17 (full build green, CTest 43/43 at the time); the seam doctrine it shipped is enforced by `check_backend_seam_symbols.sh` + the lib's CMake gates | Completed runbook with zero open items; retained as provenance for the SDL2/SDL3 dual-dispatch seam (still cited by `shs-renderer-lib` build comments and `docs/dev/build_and_setup.md`), not an active track |
| [governance_review_2026_09_18_todo.md](governance_review_2026_09_18_todo.md) | `docs/backlog/` | Closed 2026-09-18 (G1–G3, 0 open / 8 done, commit `983925c`); adopted items are enacted law in the constitutions and gates | Completed review backlog; retained as response provenance, never re-opened |
| [rasterizer_hot_path_todo.md](rasterizer_hot_path_todo.md) | `docs/backlog/` | Closed 2026-09-18 — R1–R5 resolved same day (R1 `7ca5e63`, R2 `fbf1f84`, R3 `393ebd9`, R5 `8b6484b`; R4 rejected); full CTest 50/50 | Close-out table, design-refinement notes and the recorded R3 contention benchmark preserved as provenance; the landed gates (`rasterizer_coverage_golden_tests`, `rasterizer_tile_parity_tests`) carry the law forward |
