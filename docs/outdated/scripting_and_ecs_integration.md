...
> **Status: OUTDATED (2026-09-17).** Superseded by [KDBA law](../spec/value_oriented_programming.md) and the [governing clarification](../spec/dod_ecs_architecture.md).
> ECS is not the programming model of this engine. Retained for historical context only; not normative.
