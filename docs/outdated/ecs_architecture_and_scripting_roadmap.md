...
> **Status: OUTDATED (2026-09-17).** Historical proposal, not an implementation roadmap. Superseded by [KDBA law](../spec/value_oriented_programming.md) and the [governing clarification](../spec/dod_ecs_architecture.md). ECS is not the engine's programming model.
