...
* **Isolated Comprehension:** If an inventory bug occurs, you don't debug a 400-line reducer or an entire ECS system. You look at `verify_stock()`, which is an isolated 4-line function.
