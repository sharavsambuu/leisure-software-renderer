/*
    3D Software Renderer - Blinn-Phong Shading Pipeline
...
#define MOUSE_SENSITIVITY 0.2f // Drag хийхэд хурдан байх хэрэгтэй тул бага зэрэг өсгөв
...
int main(int argc, char* argv[])
{
    ...
    // Анхаар: SDL_SetRelativeMouseMode-г АШИГЛАХГҮЙ (WSL2-д асуудалтай тул)
    ...
    // Drag хийж байгаа эсэхийг шалгах state
    ...
    while (!exit)
    {
        ...
        while (SDL_PollEvent(&event_data))
        {
            ...
            // Mouse Motion - Only rotate if dragging
