...
int main()
{
    ...
    const glm::mat4 view = shs::look_at_lh(
    ...
    const glm::mat4 perspective = shs::perspective_lh_no(1.0f, 1.5f, 1.0f, 11.0f);
    ...
    const glm::mat4 ortho = shs::ortho_lh_no(-2.0f, 2.0f, -3.0f, 3.0f, 1.0f, 11.0f);
