...
#include "shs/domains/gfx/gfx.reducer.hpp"
...
namespace
{
    auto reduce_via_pod = [](shs::gfx::GfxState& s,
                             std::span<const shs::gfx::GfxAction> a,
                             const shs::gfx::GfxReduceInputs& in,
                             std::pmr::vector<shs::gfx::GfxEvent>& e)
    {
        shs::gfx::reduce_gfx(s, a, in, e);
    };
    ...
    bool test_identity_stable()
    {
        return shs::pod_test::empty_log_is_stable<shs::gfx::GfxState,
            shs::gfx::GfxAction, shs::gfx::GfxReduceInputs,
            shs::gfx::GfxEvent>(
            reduce_via_pod, shs::gfx::GfxState{}, shs::gfx::GfxReduceInputs{});
    }

    bool test_replay_deterministic()
    {
        const shs::gfx::GfxState s0{};
        const std::vector<shs::gfx::GfxAction> none{};
        return shs::pod_test::replay_is_deterministic<shs::gfx::GfxState,
            shs::gfx::GfxAction, shs::gfx::GfxReduceInputs,
            shs::gfx::GfxEvent>(
            reduce_via_pod, s0,
            std::span<const shs::gfx::GfxAction>{none.data(), none.size()},
            shs::gfx::GfxReduceInputs{});
    }
} // namespace
