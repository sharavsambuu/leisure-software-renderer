...
#include "shs/domains/sky/sky.reducer.hpp"
...
namespace
{
    auto reduce_via_pod = [](shs::sky::SkyState& s,
                             std::span<const shs::sky::SkyAction> a,
                             const shs::sky::SkyReduceInputs& in,
                             std::pmr::vector<shs::sky::SkyEvent>& e)
    {
        shs::sky::reduce_sky(s, a, in, e);
    };
    ...
    bool test_identity_stable()
    {
        return shs::pod_test::empty_log_is_stable<shs::sky::SkyState,
            shs::sky::SkyAction, shs::sky::SkyReduceInputs,
            shs::sky::SkyEvent>(
            reduce_via_pod, shs::sky::SkyState{}, shs::sky::SkyReduceInputs{});
    }

    bool test_replay_deterministic()
    {
        const shs::sky::SkyState s0{};
        const std::vector<shs::sky::SkyAction> none{};
        return shs::pod_test::replay_is_deterministic<shs::sky::SkyState,
            shs::sky::SkyAction, shs::sky::SkyReduceInputs,
            shs::sky::SkyEvent>(
            reduce_via_pod, s0,
            std::span<const shs::sky::SkyAction>{none.data(), none.size()},
            shs::sky::SkyReduceInputs{});
    }
} // namespace
