...
namespace
{
    ...
    bool test_path_selection()
    {
        ...
        shs::renderpath::reduce_render_path(state, commands, compiler, caps, events);
    ...
    bool test_culling_mode_changes()
    {
        ...
        shs::renderpath::reduce_render_path(state, relax, compiler, occlusion_caps, events_a);
    ...
    bool test_runtime_toggles()
    {
        ...
        shs::renderpath::reduce_render_path(state, pre_plan, compiler, caps, events);
