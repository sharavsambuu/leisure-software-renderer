...
namespace
{
    ...
    bool test_replay_deterministic()
    {
        ...
        return shs::pod_test::replay_is_deterministic<shs::RuntimeState, shs::RuntimeCommand,
    ...
    bool test_empty_log_stable()
    {
        const shs::RuntimeState s0{};
        const shs::input::InputContext in{0.5f};
        return shs::pod_test::empty_log_is_stable<shs::RuntimeState, shs::RuntimeCommand,
            shs::input::InputContext, shs::input::InputEvent>(
            run_gateway, s0, in);
    }
    ...
    bool test_look_clamp()
    {
        ...
        shs::input::input_gateway(s2, std::span<const shs::RuntimeCommand>{down.data(), down.size()},
