/*
    3D Software Renderer - Threaded Oren-Nayar Shading Pipeline
...
shs::render::Color oren_nayar_fragment_shader(const shs::Varyings& in, const Uniforms& u)
{
    ...
    // Oren-Nayar загварын тогтмол коэффициентүүд
