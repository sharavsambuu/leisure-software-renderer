...
public:
    MonkeyObject(glm::vec3 pos, glm::vec3 scl, shs::Color col) : position(pos), scale(scl), color(col), rotation_angle(0.0f) { geometry = new ModelGeometry("./assets/obj/monkey/monkey.rawobj"); }
