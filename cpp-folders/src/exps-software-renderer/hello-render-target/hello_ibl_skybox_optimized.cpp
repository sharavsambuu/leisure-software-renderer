...
// ==========================================
/*
static inline glm::mat4 shs::Math::ortho_lh_zo(float left, float right, float bottom, float top, float znear, float zfar)
{
    glm::mat4 m(1.0f);
...
// sample_nearest logic is now standardized.
