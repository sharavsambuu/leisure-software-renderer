...
int main(int argc, char* argv[])
{
    ...
    // Fog/Outline outputs
    shs::Canvas fog_out    (CANVAS_WIDTH, CANVAS_HEIGHT, shs::render::Color{20,20,25,255});
    shs::Canvas outline_out(CANVAS_WIDTH, CANVAS_HEIGHT, shs::render::Color{20,20,25,255});
