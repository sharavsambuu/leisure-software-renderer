...
int main()
{
    ...
    // Drawing first line
    shs::Canvas::draw_line_naive(first_line_canvas, 13, 20, 80, 40, shs::Color::red());
    ...
    // Drawing third line
    shs::Canvas::draw_line(third_line_canvas, 13, 20, 80, 40, shs::Color::green());
    shs::Canvas::draw_line(third_line_canvas, 20, 13, 40, 80, shs::Color::red());
