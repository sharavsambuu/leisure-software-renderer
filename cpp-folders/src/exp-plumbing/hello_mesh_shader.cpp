...
private:
    ...
    void create_pipeline()
    {
        ...
        {
            vkDestroyShaderModule(dev, ms, nullptr);
        ...
        gp.stageCount = 2;
        gp.pStages = stages;
        gp.pVertexInputState = nullptr; // Null for mesh shader pipelines
        gp.pInputAssemblyState = nullptr; // Null for mesh shader pipelines
    ...
    void draw_frame()
    {
        ...
        clear_values[0].color = {{0.09f, 0.04f, 0.05f, 1.0f}};
